package org.hanson.eddyshop.security.config;


import lombok.RequiredArgsConstructor;
import org.hanson.eddyshop.security.jwt.AuthTokenFilter;
import org.hanson.eddyshop.security.jwt.JwtAuthEntryPoint;
...
public class ShopConfig {
    ...
    private static final List<String> SECURE_URLS = List.of(
            "/api/v1/cart/**","/api/v1/cartItems/**" ,"/api/v1/product/**" );
